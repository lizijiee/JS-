...
class Temp extends Component {
        ...
        if (ele == null) {
            ...
            return (
                <tr key={ele.spuId} id={ele.spuId}  >
                    ...
                    <td> {ele.categoryName === "优惠"?"已经推荐":"未推荐"}</td>
                    <td>
                        <Switch
                            size="default"
                            defaultChecked={ele.categoryName === "优惠"}
                            onClick={(valid) => {
                                this.switchChange(valid, "优惠", ele)
                            }}
                        />
                    </td>
                    <td>
    ...
    */
    ...
    render() {
        ...
        return (
            <section className="marketing-info-discount">
                {/*   员工信息组件  */}
