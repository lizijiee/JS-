...
export default class FormItem extends React.Component<FormItemProps, any> {
    ...
    renderHelpHolder(prefixCls: string): JSX.Element | null;
    renderExtra(prefixCls: string): JSX.Element | null;
    getValidateStatus(): "error" | "" | "success" | "validating";
    renderValidateWrapper(prefixCls: string, c1: React.ReactNode, c2: React.ReactNode, c3: React.ReactNode, helperHolder: React.ReactNode): JSX.Element;
