...
function (_React$Component) {
  ...
  _createClass(FormItem, [{
    ...
    key: "renderHelpHolder",
    value: function renderHelpHolder(prefixCls) {
    ...
    value: function renderValidateWrapper(prefixCls, c1, c2, c3, helperHolder) {
    ...
    value: function renderChildren(prefixCls) {
      ...
      return [this.renderLabel(prefixCls), this.renderWrapper(prefixCls, this.renderValidateWrapper(prefixCls, children, this.renderHelp(prefixCls), this.renderExtra(prefixCls), this.renderHelpHolder(prefixCls)))];
    }
  }, {
    key: "render",
